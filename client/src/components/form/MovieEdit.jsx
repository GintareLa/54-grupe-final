...
export function MovieEditForm() {
    ...
    function handleImageChange(e) {
        ...
        fetch('http://localhost:5434/api/admin/upload', {
            method: 'POST',
            credentials: 'include',
            body: formData,
        })
    ...
    function handleMainFormSubmit(e) {
        ...
        fetch('http://localhost:5434/api/admin/movies/' + id, {
            method: 'PUT',
            headers: {
            ...
            <form onSubmit={handleMainFormSubmit} className="needs-validation col-12 col-md-10 col-lg-8 col-xl-6">
                <div className="row g-3">
                    ...
                    <div className="col-12 col-sm-6">
                        ...
                        <select onChange={e => setCategory(e.target.value)} value={category} className="form-control" id="category">
